      ...
      <div class="col-md">
            <div class="widget-rounded-circle card-box">
                  <div class="row justify-content-between">
                        <h4 class="header-title" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Stock Bulanan Devisi PT. <?= $this->session->userdata('app_pt'); ?></h4>
...
<script>
      ...
      function listStockAwal() {
            ...
            var table = $('#tableStockAwal_harian').DataTable({
                  ...
                  "ajax": {
                        "url": "<?php echo site_url('Stok/get_ajax_bulanan') ?>",
                        "type": "POST"
                  },
