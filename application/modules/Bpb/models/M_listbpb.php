...
class M_listbpb extends CI_Model
{

    var $table = 'bpbitem'; //nama tabel dari database
    var $column_order = array(null, 'id', 'nobpb', 'norefbpb', 'kodebar', 'nabar', 'satuan', 'qty_disetujui'); //field yang ada di table user
    var $column_search = array('nobpb', 'norefbpb', 'kodebar', 'nabar', 'satuan', 'qty_disetujui'); //field yang diizin untuk pencarian 
    ...
    public function where_datatables($nobpb, $norefbpb)
    {
        // global $nopo;
        $this->nobpb = $nobpb;
        $this->norefbpb = $norefbpb;
        // return $nopo;
    }
