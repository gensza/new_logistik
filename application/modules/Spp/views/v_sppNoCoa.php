            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between" style="margin-top: -10px;">
                        <h4 class="header-title ml-2 mb-3">Data SPP Tanpa Coa</h4>
                    ...
                    <div class="table-responsive" style="margin-top: -10px;">
                        <table id="dataspp_nocoa" class="table w-100 dataTable no-footer table-bordered table-striped">
                            <thead>
                                <tr>
...
<script type="text/javascript">
    ...
    function dataSppFilter(data) {
        $('#dataspp_nocoa').DataTable().destroy();
        $('#dataspp_nocoa').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Spp/get_spp_noCoa') ?>",
                "type": "POST",
                "data": {
                    data: data
                }
