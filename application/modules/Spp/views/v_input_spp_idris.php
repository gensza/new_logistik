    ...
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="widget-rounded-circle card-box mt-2">
                <h4 class="header-title" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
                    SPP
                </h4>
                <p class="sub-header">
                ...
                <div class="row div_form_2">
                    <div class="col-sm-12">
                        ...
                        <div class="table-responsive">
                            <table id="tableRinciBarang" style="height: auto;" class="table table-striped table-bordered table-in">
                                <thead>
                                ...
                                <tbody id="tbody_rincian" name="tbody_rincian" style="height: max-content;">
                                    <tr id="tr_1" style="height: 0;">
                                        <td width="3%" style="padding-right: 0.2em; padding-left: 0.2em;  padding-top: 2px; padding-bottom: 0.1em; height: auto;">
                                        ...
                                        <form id="form_rinci_1" name="form_rinci_1" method="POST" action="javascript:;">
                                            <td width="35%" style="padding-right: 0.2em; padding-left: 0.2em;  padding-top: 2px; padding-bottom: 0.1em; height: min-content;">
                                                <input type="text" class="form-control" style="margin-bottom: -0px;" id="nakobar_1" name="txt_cari_kode_brg_1" placeholder="Cari Kode/Nama Barang" onfocus="cari_barang('1')"><br />
                                            ...
                                            <td width="10%" style="padding: 0.1em !important;">
                                                <input type="number" class="form-control" id="txt_qty_1" style="padding-bottom: 0px !important" name="txt_qty_1" placeholder="Qty" size="26" required /><br />
                                            </td>
                                            <td width="8%">
                                                <span id="stok_1"></span>
                                                <span> </span>
                                            ...
                                            <td style="padding-right: 0.2em; padding-left: 0.2em;  padding-top: 2px; padding-bottom: 0.1em; height: auto;">
                                            ...
                                            <td width="8%" style="padding-top: 2px; padding-bottom: 0.1em; height: auto;">
                                                <div class="row">
