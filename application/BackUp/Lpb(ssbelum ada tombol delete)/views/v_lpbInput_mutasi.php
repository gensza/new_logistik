            ...
            <div class="col-md">
                  <div class="widget-rounded-circle card-box mt-2">
                        <div class="row justify-content-between">
                              <h4 class="header-title ml-2" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">LPB <b>MUTASI</b></h4>
                              <h4 class="header-title mr-2" style="font-family: Verdana, Geneva, Tahoma, sans-serif;"><span id="noref_span"></span></h4>
                        </div>
                        ...
                        <div class="row div_form_1">
                              ...
                              <div class="row col-9">
                                    <div class="col-3">
                                          <!-- assignee -->
                                          <p class="text-muted mb-0">Tanggal BKB</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
                                                            <span id="tgl_bkb_txt"></span>
                                                      </h5>
                                                </div>
                                          </div>
                                          <!-- end assignee -->
                                    ...
                                    <div class="col-3">
                                          <!-- start due date -->
                                          <p class="text-muted mb-0">Kepada</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
                                    ...
                                    <div class="col-3">
                                          <!-- start due date -->
                                          <p class="text-muted mb-0">Keperluan</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
                        ...
                        <div class="row mt-1">
                              ...
                              <div class="row col-9">
                                    <div class="col-3">
                                          <!-- assignee -->
                                          <p class="text-muted mb-0">Asal PT</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
                                    ...
                                    <div class="col-3">
                                          <!-- start due date -->
                                          <p class="text-muted mb-0">Asal Devisi</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
                                    ...
                                    <div class="col-3">
                                          <!-- start due date -->
                                          <p class="text-muted mb-0">PT Tujuan</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
                                    ...
                                    <div class="col-3">
                                          <!-- start due date -->
                                          <p class="text-muted mb-0">Devisi Tujuan</p>
                                          <div class="media">
                                                <div class="media-body">
                                                      <h5 class="mt-0 font-size-14">
...
<script>
      ...
      function tambah_row(row, ) {
            ...
            var td_col_4 = '<td style="padding-right: 0.4em; padding-left: 0.4em; padding-top: 1px; padding-bottom: 0em;">' +
                  '<span class="small text-muted" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size:small">qty&nbsp;BKB&emsp;:&nbsp;</span><span id="qty_po_' + row + '" class="small" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size:small"></span><br>' +
      ...
      function cariBkbItemqr(noref) {
            ...
            $.ajax({
                  ...
                  success: function(data) {
                        ...
                        $('#noref_span').text(data_mutasi.NO_REF);
