        ...
        <table class="singleborder" width="100%" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right; background-color: grey;">0</td>
                </tr>
            </tbody>
        </table>
        <?php } else {
        foreach ($bkb_brg as $bb) { ?>
            <table border="0" width="100%">
                <thead>
                    <tr>
            ...
            <table class="singleborder" width="100%" border="1">
                ...
                <tbody>
                    ...
                    $bagian = $bb->bag;
                    if ($bagian == 'Semua') {
                        $query = "SELECT a.*, b.bag FROM keluarbrgitem a, stockkeluar b WHERE a.NO_REF = b.NO_REF AND kodebar = '$bb->kodebar' AND  a.periode BETWEEN '$tgl1' AND '$tgl2' AND a.batal = '0' AND a.kode_dev = '$lokasi' ";
                    } else {
                        $query = "SELECT a.*, b.bag FROM keluarbrgitem a, stockkeluar b WHERE a.NO_REF = b.NO_REF AND kodebar = '$bb->kodebar' AND  a.periode BETWEEN '$tgl1' AND '$tgl2' AND a.batal = '0' AND a.kode_dev = '$lokasi' AND b.bag = '" . $bagian . "'";
